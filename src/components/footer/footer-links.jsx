...
function FooterLinks() {
    ...
    return <div className="container footer-links">
        <div className="row">
                    ...
                    <div className="col-xl-4">
                        ...
                        <ul>
                            {company?.map(({name, href}) =>
                                <li key={href}><Link href={href}>{name}</Link>
                                </li>)}
                        </ul>
                    </div>
                    <div className="col-xl-4">
                ...
                <div className="row">
                    <div className="col-xl-12">
                        <div className="position-relative d-flex align-items-center">
                            <Image src="/icons/location.png" width={12} height={20} alt={"Location-icon"}/>
                            <p className="mx-3">Sefaköy Ave, Küçükçekmece <br/> District, Istanbul</p>
                        </div>
